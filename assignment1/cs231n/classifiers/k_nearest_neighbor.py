...
class KNearestNeighbor(object):
  ...
  def compute_distances_no_loops(self, X):
    ...
    #return
    dists = np.sqrt(train_square + test_square - 2*np.dot(X, self.X_train.T))
    # break
    #########################################################################
    #                         END OF YOUR CODE                              #
    #########################################################################
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      #########################################################################
      correponding_distance = dists[i] 
      sorted_indices = np.argsort(correponding_distance)
      ...
      # label.                                                                #
      #########################################################################
      k_nearest_label = [self.y_train[index] for index in k_nearest_indices]
      

      y_pred[i] = max(set(k_nearest_label), key=k_nearest_label.count)
      #########################################################################
      #                           END OF YOUR CODE                            # 
      #########################################################################
